<div class="container">
<h1 class="text-center">Edit Classroom Information</h1>
        <form id="myForm" action="<?php echo site_url('updateClassroom'); ?>" method="POST">
            <input type="hidden" name="class_id" value="<?php echo ($classRoomId); ?>">
            <div class="form-group">
                <label for="class_subject">Class Subject:</label>
                <input type="text" class="form-control" id="class_subject" name="class_subject" value="<?php echo ($classroomData['classroom']['Class_Subject']); ?>" required>
            </div>
			<div class="form-group">
				<label for="class_StartTime">Class Begin Time:</label>
				<input type="time" id="class_StartTime" name="class_StartTime" value="<?php echo ($classroomData['classroom']['Class_StartTime']); ?>" required>
				<label for="class_EndTime" style="margin-left:20px">Class End Time:</label>
				<input type="time" id="class_EndTime" name="class_EndTime" value="<?php echo ($classroomData['classroom']['Class_EndTime']); ?>" required>
                ...
                <select class="form-control" id="teacher_id" name="teacher_id" required>
                    <?php foreach ($teacherCL as $teachers): ?>
                        <option value="<?php echo ($teachers['Teacher_ID']); ?>" 
                            <?php echo $classroomData['classroom']['Teacher_ID'] == $teachers['Teacher_ID'] ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-item">
                        ...
                        <?php foreach ($studentCL as $student): ?>
                            <div class="checkbox-item">
                            <label style="font-weight:normal;">
                                <input type="checkbox" name="students[]" value="<?php echo $student['Student_ID']; ?>" <?php echo in_array($student['Student_ID'], $classroomData['students']) ? 'checked' : ''; ?>> 
